...
<template>
  <div
      className="bg-[#1B2028] rounded-[10px] p-[20px] w-[1000px] flex flex-wrap justify-around"
  >
    ...
    <div class="w-full flex justify-center mb-4">
      <select
          ...
          class="bg-[#151a21] text-white border border-gray-600 rounded px-3 py-1 text-sm"
      >
    ...
    <div v-for="coin in topCoins" :key="coin.id" className="w-[45%] mb-6">
      <h2 class="text-white font-bold text-center mb-2">
        {{ coin.symbol }} Price
      </h2>
      <Line
